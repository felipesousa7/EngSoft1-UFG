...
if($btnEdita){
    $idEntrevista = filter_input(INPUT_POST, 'btnEdita', FILTER_SANITIZE_STRING);
    ...
    $sqlVisibilidade = "UPDATE entrevistas SET visivel = 0 WHERE id = ?";
    if( $stmt = mysqli_prepare($conn, $sqlVisibilidade) ){
